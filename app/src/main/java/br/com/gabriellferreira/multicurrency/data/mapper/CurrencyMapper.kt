...
class CurrencyMapper @Inject constructor() {
    ...
    fun map(data: CurrencyData): Currency {
        ...
        return Currency(id = foreignCurrency.id,
                base = data.base ?: "",
    ...
    enum class ForeignCurrency(val id: Int,
                               @DrawableRes val flagIcon: Int,
                               val coinName: String,
                               val exponent: Int) {
        AUD(id = 36, flagIcon = R.drawable.ic_australia, coinName = "Australian dollar", exponent = 2),
        ...
        CZK(id = 203, flagIcon = R.drawable.ic_czech_republic, coinName = "Czech koruna", exponent = 2),
        ...
        GBP(id = 826, flagIcon = R.drawable.ic_united_kingdom, coinName = "Pound sterling", exponent = 2),
        HKD(id = 344, flagIcon = R.drawable.ic_hong_kong, coinName = "Hong Kong dollar", exponent = 2),
        HRK(id = 191, flagIcon = R.drawable.ic_croatia, coinName = "Croatian kuna", exponent = 2),
        HUF(id = 348, flagIcon = R.drawable.ic_hungary, coinName = "Hungarian forint", exponent = 2),
        IDR(id = 360, flagIcon = R.drawable.ic_indonesia, coinName = "Indonesian rupiah", exponent = 2),
        ILS(id = 376, flagIcon = R.drawable.ic_israel, coinName = "Israeli new shekel", exponent = 2),
        ...
        KRW(id = 410, flagIcon = R.drawable.ic_south_korea, coinName = "South Korean won", exponent = 0),
        MXN(id = 484, flagIcon = R.drawable.ic_mexico, coinName = "Mexican peso", exponent = 2),
        MYR(id = 458, flagIcon = R.drawable.ic_malaysia, coinName = "Malaysian ringgit", exponent = 2),
        NOK(id = 578, flagIcon = R.drawable.ic_norway, coinName = "Norwegian krone", exponent = 2),
        NZD(id = 554, flagIcon = R.drawable.ic_new_zealand, coinName = "New Zealand dollar", exponent = 2),
        PHP(id = 608, flagIcon = R.drawable.ic_philippines, coinName = "Philippine peso", exponent = 2),
        PLN(id = 985, flagIcon = R.drawable.ic_republic_of_poland, coinName = "Polish złoty", exponent = 2),
        ...
        SGD(id = 702, flagIcon = R.drawable.ic_singapore, coinName = "Singapore dollar", exponent = 2),
        ...
        USD(id = 840, flagIcon = R.drawable.ic_united_states_of_america, coinName = "United States dollar", exponent = 2),
        ZAR(id = 710, flagIcon = R.drawable.ic_south_africa, coinName = "South African rand", exponent = 2);
